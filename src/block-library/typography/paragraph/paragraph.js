 ...
 */
export default function Paragraph({ attributes, setAttributes, clientId }) {
	...
	const { code, copyable, disabled, mark, italic, strong, type, underline } =
		savedAttributes.api;
	...
	return (
		<>
			<Typography.Paragraph {...blockProps} {...antdComponentProps}>
				<RichText
			...
			<style>
				{generateStyles(savedAttributes, clientId, token, ".ant-typography")}
			</style>
